...
public class AlterTest extends JFrame implements ActionListener,ItemListener {
...
//		((Graphics2D) g).setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, opacity));
		...
		JLabel heading = new JLabel("TEST  ALTERATION");
	...
	public void alter()
	{
		String sql = "update test set testName='"+testNameTextField.getText()+"', remarks='"+remarksTextArea.getText()+"' where testId="+testIdTextField.getSelectedItem();
		try {
